        ...
        <div className="flex-1 min-h-0 overflow-y-auto pb-24">
          ...
          {tab === 'home' && (
            <div className="p-4 space-y-4">
              ...
              {/* PDF Maker — always visible */}
              <a href="/pdf"
                className="block rounded-2xl bg-blue-600 text-white px-5 py-4 shadow active:scale-95 transition-all flex items-center gap-4">
                <div className="text-3xl shrink-0">📄</div>
                <div>
                  <div className="font-black text-base leading-tight">PDF Maker</div>
                  <div className="text-blue-200 text-xs mt-0.5">Add photos → write text → share via WhatsApp</div>
                </div>
